...
app.get('/', (c) => {
  ...
  return c.html(`
    ...
    <body>
        ...
        <!-- 챗봇 -->
        <div id="chatbotIcon" class="chatbot-icon" style="position: fixed; bottom: 24px; right: 24px; width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 20px rgba(102, 126, 234, 0.4); z-index: 999;">
            <i class="fas fa-comments" style="color: white; font-size: 28px;"></i>
        </div>

        <div id="chatbotWindow" class="chatbot-window hidden" style="position: fixed; bottom: 100px; right: 24px; width: 380px; height: 600px; background: white; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.2); display: flex; flex-direction: column; z-index: 1000;">
            <div class="chatbot-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 16px; border-radius: 16px 16px 0 0; color: white; display: flex; justify-content: space-between; align-items: center;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <div style="width: 40px; height: 40px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-robot"></i>
                    </div>
                    <div>
                        <h3 id="chatbotTitle" style="font-size: 16px; margin-bottom: 4px;">FeeZero 케어봇</h3>
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                    <div class="language-selector" style="display: flex; gap: 4px;">
                        <button class="lang-btn active" onclick="window.changeChatLanguage('ko')" title="한국어" style="background: rgba(255,255,255,0.4); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px;">🇰🇷</button>
                        <button class="lang-btn" onclick="window.changeChatLanguage('en')" title="English" style="background: rgba(255,255,255,0.2); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px;">🇺🇸</button>
                        <button class="lang-btn" onclick="window.changeChatLanguage('zh')" title="中文" style="background: rgba(255,255,255,0.2); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px;">🇨🇳</button>
                        <button class="lang-btn" onclick="window.changeChatLanguage('ja')" title="日本語" style="background: rgba(255,255,255,0.2); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px;">🇯🇵</button>
                    </div>
                    <button id="closeChatbot" style="background: none; border: none; color: white; cursor: pointer; font-size: 20px; padding: 4px;">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
            </div>
            <div id="chatMessages" style="flex: 1; overflow-y: auto; padding: 16px; background: #f9fafb;"></div>
            <div id="quickReplies" style="padding: 8px 16px; display: flex; flex-wrap: wrap; gap: 8px;"></div>
            <div id="typingIndicator" class="hidden" style="display: flex; gap: 12px; padding: 0 16px 16px;">
                <div style="width: 36px; height: 36px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white;">
                    <i class="fas fa-robot"></i>
                </div>
                <div style="background: white; border: 1px solid #e5e7eb; padding: 12px 16px; border-radius: 12px; display: flex; gap: 4px;">
                    <span style="width: 6px; height: 6px; background: #9ca3af; border-radius: 50%; animation: typing 1.4s infinite;"></span>
                    <span style="width: 6px; height: 6px; background: #9ca3af; border-radius: 50%; animation: typing 1.4s 0.2s infinite;"></span>
                    <span style="width: 6px; height: 6px; background: #9ca3af; border-radius: 50%; animation: typing 1.4s 0.4s infinite;"></span>
                </div>
            </div>
            <div style="padding: 12px 16px; border-top: 1px solid #e5e7eb; display: flex; gap: 8px; align-items: center;">
                <textarea id="userInput" placeholder="메시지를 입력하세요..." rows="1" style="flex: 1; padding: 10px 14px; border: 1px solid #e5e7eb; border-radius: 20px; font-size: 14px; resize: none; font-family: inherit;"></textarea>
                <button id="sendBtn" style="width: 40px; height: 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 50%; color: white; cursor: pointer; display: flex; align-items: center; justify-content: center;">
        ...
        .quick-reply-btn { padding: 8px 12px; background: white; border: 1px solid #e5e7eb; border-radius: 20px; font-size: 13px; cursor: pointer; }
        .quick-reply-btn:hover { background: #f3f4f6; border-color: #667eea; }
        </style>
