...
app.get('/', (c) => {
  ...
  return c.html(`
    ...
    <body>
        ...
        <!-- 챗봇 -->
        <div id="chatbotIcon" style="position: fixed; bottom: 24px; right: 24px; width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 20px rgba(102, 126, 234, 0.4); z-index: 999;">
        ...
        <div id="chatbotWindow" class="hidden" style="position: fixed; bottom: 100px; right: 24px; width: 400px; height: 650px; background: white; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.2); display: flex; flex-direction: column; z-index: 1000;">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 16px; border-radius: 16px 16px 0 0; color: white; display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                    <div style="display: flex; gap: 4px;">
                        <button class="lang-btn active" onclick="window.changeChatLanguage('ko')" title="한국어" style="background: rgba(255,255,255,0.4); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px; transition: all 0.2s;">🇰🇷</button>
                        <button class="lang-btn" onclick="window.changeChatLanguage('en')" title="English" style="background: rgba(255,255,255,0.2); border: none; padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 18px; transition: all 0.2s;">🇺🇸</button>
            ...
            <div style="padding: 16px; background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                <div id="faqSubtitle" style="font-size: 18px; font-weight: 600; color: #1f2937; margin-bottom: 12px;">자주 묻는 질문</div>
                <div style="position: relative;">
                    <input id="searchInput" type="text" placeholder="질문 검색..." style="width: 100%; padding: 10px 40px 10px 14px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px; font-family: inherit;">
                    <i class="fas fa-search" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #9ca3af;"></i>
                </div>
            </div>

            <!-- FAQ 리스트 -->
            <div id="faqContainer" style="flex: 1; overflow-y: auto; padding: 8px; background: #f9fafb;"></div>
        </div>
        ...
        #faqContainer::-webkit-scrollbar { width: 6px; }
        #faqContainer::-webkit-scrollbar-track { background: #f3f4f6; }
        #faqContainer::-webkit-scrollbar-thumb { background: #d1d5db; border-radius: 3px; }
        #faqContainer::-webkit-scrollbar-thumb:hover { background: #9ca3af; }
